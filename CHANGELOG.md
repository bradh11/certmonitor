...
- Signature verification refuses an Ed25519 or Ed448 public key of small order, whose signatures verify under every other key of that order (RFC 8032 section 8.4), and a `pathLenConstraint` or RSASSA-PSS parameter integer carrying a second leading zero octet, which is not minimal DER.
