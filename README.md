...
- 🚫 **Revocation:** the opt-in `revocation` validator asks the certificate's OCSP responder and CRL distribution points, with CRL answers verified by OpenSSL. See [Revocation](https://certmonitor.readthedocs.io/en/latest/validators/revocation/).
