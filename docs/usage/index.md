...
Already monitoring a fleet? Jump to [Performance Tips](performance.md). Upgrading an existing integration? Read the [release notes](https://github.com/bradh11/certmonitor/releases) before changing versions.
